...
This project demonstrates the creation of an IAM user with limited permissions(EC2, S3 only), deployment of a cost controlled EC2 instance that automatically 
